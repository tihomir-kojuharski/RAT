...
dataset_assets = ['XOM', 'GE', 'MSFT', 'C', 'T', 'PG'] #, 'BAC'] #, 'PG', 'WMT', 'PFE', 'MO', 'AIG', 'JNJ']
...
params = Parameters(
    dataset=DatasetParameters(
        ...
        dataset_features=['close', 'high', 'low', 'open', 'volume', 'pe_ratio_ttm', 'eps_surprise_percentage', 'rsi'],
